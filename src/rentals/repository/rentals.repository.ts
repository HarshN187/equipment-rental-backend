...
> {
  ...
  public mapToResponse(body: RentalDto) {
    return this.mapper.map(body, RentalDto, GetRentalResDto);
  }

  public mapToResponseArray(body: RentalDto[]) {
    return this.mapper.mapArray(body, RentalDto, GetRentalResDto);
  }
}
